...
#ifndef FV_REF_COUNT_H
#define FV_REF_COUNT_H
...
static inline void
fv_ref_count_init(struct fv_ref_count *ref_count)
{
#ifndef HAVE_SYNC_REF_COUNT
...
static inline void
fv_ref_count_ref(struct fv_ref_count *ref_count)
{
...
static inline int
fv_ref_count_unref(struct fv_ref_count *ref_count)
{
        int old_value;
...
static inline void
fv_ref_count_destroy(struct fv_ref_count *ref_count)
{
#ifndef HAVE_SYNC_REF_COUNT
